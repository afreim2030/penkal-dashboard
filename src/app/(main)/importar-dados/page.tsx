...
import { ImportAdsCard } from "./_components/import-ads-card";
...
export default async function Page() {
  ...
  return <main className="flex flex-col gap-4">
    <div className="flex flex-col gap-1"><h1 className="text-3xl tracking-tight">Importar Dados</h1><p className="text-muted-foreground text-sm">Envie relatórios do Mercado Livre para atualizar os dados do sistema.</p></div>
